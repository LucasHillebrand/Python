...
class fw:
    ...
    def ChWin(show, p):
        ...
        # !###
        if I > 2:
            if show[I - 1][IT] == p and show[I - 2][IT] == p and show[I - 3][IT] == p:
               return True
        if I > 2 and IT > 2:
            if show[I - 1][IT-1] == p and show[I - 2][IT-2] == p and show[I - 3][IT-3] == p:
               return True
        if IT < 4 and I < 5:
            if show[I+1][IT+1] == p and show[I+1][IT+1] == p and show[I+1][IT+1] == p:
                return True
        if IT < 4 and I > 2:
            if show[I-1][IT+1] == p and show[I-2][IT+2] == p and show[I-3][IT+3] == p:
                return True
        ...
        if I < 4:
            if show[I+1][IT] == p and show[I+2][IT] == p and show[I+3][IT] == p:
                return True
        if IT > 2:
            if show[I][IT-1] == p and show[I][IT-2] == p and show[I][IT-3] == p:
                return True
        # #!##
        if I > 0 and I < 5:
            if show[I-1][IT] == p and show[I+1][IT] == p and show[I][IT+2] == p:
                return True
        if I > 1 and I < 6:
            if show[I-1][IT] == p and show[I-2][IT] == p and show[I+1][IT] == p:
                return True

        # X
        #/
        if I > 0 and I < 5 and IT > 0 and IT < 4:
            if show[I-1][IT+1] == p and show[I+1][IT+1] == p and show[I+2][IT+2] == p:
                return True
        if I > 1 and I < 6 and IT > 1 and IT < 5:
            if show[I+1][IT-1] == p and show[I+2][IT-2] == p and show[I+1][IT+1] == p:
                return True
        #\
        if I > 0 and I < 5 and IT > 0 and IT < 4:
            if show[I-1][IT-1] == p and show[I-1][IT+1] == p and show[I-2][IT+2] == p:
